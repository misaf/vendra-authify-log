...
description: "Use this skill when creating, modifying, reviewing, or testing the Vendra Authify Log module in app-modules/vendra-authify-log, or when creating future authify-log-like Filament/domain modules. Trigger for `AuthifyLog` models, vendra-authify-log migrations, factories, seeders, policies, permission enums, Filament resources, clusters, forms, tables, relation managers, translations, media collections, plugin/service provider wiring, and module configuration."
---
...
Treat `app-modules/vendra-authify-log` as the source of authify-log domain behavior and Filament admin UI.
...
- Run module checks from the package when possible: `composer --working-dir=app-modules/vendra-authify-log test` and `composer --working-dir=app-modules/vendra-authify-log analyse`.
